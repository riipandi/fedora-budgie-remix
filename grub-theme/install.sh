...
# Set variables
Theme_Name="grub2-solarium"			# The theme will be installed in a dir with this name. Avoid spaces.
...
if [[ $Theme_Resolution = "any" ]]; then
	echo ""
	echo "Enter desired resolution in the form of 800x600, 1024x768, 1366x768, 1600x1200, etc."
